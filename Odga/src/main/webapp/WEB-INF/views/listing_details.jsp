        ...
        <div class="listing-caption section-padding">
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    <!--End Map -->
                    <div class="col-lg-6">
                        <h3 class="mb-20">설명</h3>
                        <p class="mb-30">한강공원이 조성되기 이전부터 강변유원지로 유명했던 곳입니다. 수상에서는 시원한 바람을 맞으며 낭만과 젊음을 만끽할 수 있는 윈드 서핑, 수상스키, 모터보트 등 수상스포츠가 활발하게 이루어지고 있습니다.</p>
                        <p class="mb-10">면 적 : 825,000㎡</p>
                        <p class="mb-10">길 이 : 11.5km(서울시계(광진교 상류 육상 ~ 중랑천교)</p>
                        <p class="mb-10">주 소 : 서울시 광진구 강변북로 139 (자양동 704-1)</p>
                        <p class="mb-10">뚝섬안내센터 : ☎ 02)3780-0521~4</p>
                    </div>
                </div>
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        <h3 class="mb-20">일반현황</h3>
                        <p class="mb-10">뚝섬한강공원 안내센터 : 3780-0521~4</p>
                        <p class="mb-10">위 치 : 광진구 강변북로 139 (자양동)</p>
                        <p class="mb-10">관할구역 : 광진교 상류 육상(시계)~중랑천교(11.5㎞)</p>
                        <p class="mb-10">면 적 : 약 825,000㎡</p>
                        <p class="mb-5">
                            <p>주요시설 : 뚝섬 벽천마당(벽천분수, 인공암벽), 수영장, 음악분수,X-게임장, 수변무대
                                접근시설 : 전망복합 문화시설 1, 도로진출입로 4, 나들목 11, 경사로 4, 지하보도 2, 보도육교 1</p>
                            <p>조경시설 : 잔디 335,006㎡, 교목 3,147주, 관목 244,007주, 초화원 18,717㎡, 장미원 6,040㎡, 소생물 서식지 5,800㎡, 호안초지 50,610㎡</p>
                            <p>수상시설 : 수상관광 콜택시 선착장 1, 선착장 1</p>
                            <p>편의시설 : 매점 3개소, 주차장 3개소, 화장실 21(이동),1(개방), 음수대 21개, 그늘막 및 파고라 37개, 놀이터 2개소, 의자 322개, 공원등(310개소)</p>
                            <p>※주차장 : 3개소 총661면</p>
                        </p>
                    </div>
                </div>
                <!-- listing Details Stat-->
                <div class="listing-details-area section-padding">
                    <div class="container">
                        <div class="row">
